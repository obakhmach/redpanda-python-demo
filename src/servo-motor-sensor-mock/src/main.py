...
@click.option(
    ...
    "servo_position",
    required=True,
    help="The position of the servo on the drone.",
    type=click.Choice(["FRONT_LEFT", "FRONT_RIGHT", "BACK_LEFT", "BACK_RIGHT"]),
)
@click.option(
    "-l",
    "--log-level",
...
def cli(
    ...
    main(redpanda_host, redpanda_port, redpanda_topic, servo_position, log_level)
